...
package org.flixel.plugin.photonstorm
{
	...
	public class FlxButtonPlus extends FlxGroup
	{
		...
		/**
		 * EDITED: This is used to pass a class and set this as the graphic for the normal button		
		 */
		public function setGraphic(Graphic:Class,Animated:Boolean=false,Reverse:Boolean=false,Width:uint=0,Height:uint=0,Unique:Boolean=false):void
		{
			buttonNormal.loadGraphic(Graphic, Animated, Reverse, Width, Height, Unique);
		}
